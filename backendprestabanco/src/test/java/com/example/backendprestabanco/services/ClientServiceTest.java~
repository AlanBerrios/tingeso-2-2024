...
class ClientServiceTest {
    ...
    public void whenSaveClient_thenReturnSavedClient() {
        // given
        ClientEntity clientToSave = new ClientEntity("17.777.457-8", "Esteban", "Marquez", "esteban@gmail.com", "123456789", 40000.0, "Fair", 35, "Employee", 10);
    ...
    public void whenUpdateClient_thenReturnUpdatedClient() {
        // given
        ClientEntity clientToUpdate = new ClientEntity("12.345.678-9", "Marco", "Jimenez", "marco@gmail.com", "987654321", 45000.0, "Good", 40, "Self-Employed", 15);
